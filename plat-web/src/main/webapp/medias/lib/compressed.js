...
TINY.slideshow.prototype = {
    init: function(s, z, b, f, q) {
        ...
        if (this.thumbs) {
            ...
            this.p = mm(this.thumbs)
        }
        for (i; i < this.l; i++) {
            this.a[i] = {};
            var h = m[i],
                a = this.a[i];
            a.t = mmmm('h3', h)[0].innerHTML;
            a.d = mmmm('p', h)[0].innerHTML;
            a.l = mmmm('a', h)[0] ? mmmm('a', h)[0].href: '';
            a.p = mmmm('span', h)[0].innerHTML;
            if (this.thumbs) {
                var g = mmmm('img', h)[0];
    ...
    nf: function(s) {
        if (this.info) {
            s = this.a[s];
            mmmm('h3', this.r)[0].innerHTML = s.t;
            mmmm('p', this.r)[0].innerHTML = s.d;
