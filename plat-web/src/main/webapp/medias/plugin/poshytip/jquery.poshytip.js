...
(function($) {
	...
	$.Poshytip.prototype = {
		...
		refresh: function(async) {
			...
			$(".form_box").append(this.$tip.css({left: 0, top: 20}));
			...
			if (bgImage) {
				...
				if (ie6 && bgImagePNG) {
					...
					this.$tip.prepend('<table class="shtiptable" border="0" cellpadding="0" cellspacing="0"><tr><td class="tip-top tip-bg-image" colspan="2"><span></span></td><td class="tip-right tip-bg-image" rowspan="2"><span></span></td></tr><tr><td class="tip-left tip-bg-image" rowspan="2"><span></span></td><td></td></tr><tr><td class="tip-bottom tip-bg-image" colspan="2"><span></span></td></tr></table>')
		...
		calcPos: function() {
			var $wins = this.$elm.parents(".form_box"),
				$win;
			if($wins.length == 0){
				$win = $(window);
			}else{
			...
			var elmOffset = this.$elm.offset(),
				elm = {
					l: elmOffset.left,
					t: elmOffset.top,
					w: this.$elm.position().left,
					h: this.$elm.position().top
				};
			pos.t = elm.h + win.st - win.l - 40;
			pos.l = elm.w + win.sl - win.t;
			pos.arrow = 'bottom';
			this.pos = pos;
			//if (this.opts.alignTo == 'cursor') {
			...
			//			l: elmOffset.left,
			//			t: elmOffset.top,
			//			w: this.$elm.outerWidth() - win.w,
			//			h: this.$elm.outerHeight() - win.h
			//		};
