...
import net.ruixin.util.support.exception.ToolBoxException;
...
public class Convert {
    ...
    public static Object parse(Class<?> clazz, Object value) {
        try {
            ...
            if (Date.class.isAssignableFrom(clazz)) {
                ...
                return valueStr.getBytes(Charset.forName("UTF-8"));
            }
            // 未找到可转换的类型，返回原值
    ...
    public static String toHex(String str) {
        return HexKit.encodeHexStr(str.getBytes(Charset.forName("UTF-8")));
    }
