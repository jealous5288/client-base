...
public class NumberToRMBUtil {
     ...
     * @return
     */
    private static String changeDigit(String str, boolean bo) {
     ...
     * @return
     */
    private static String readNumber(String str, boolean bo) {
        StringBuffer strbu = new StringBuffer();
        if (str.length() != 4) {
            return null;
        }
     ...
     * @return
     */
    private static String changeInteger(long lon, boolean bo) {
        StringBuffer strbu = new StringBuffer();
        // :增加3位数,为了完成大写转换
        String strN = "000" + lon;
    ...
    public static String changeNumberRMB(double rmb) {
        ...
        if (strRMB.indexOf("点") >= 0) {
            ...
            strRMB = str1 + str2.charAt(0) + "角" + str2.charAt(1) + "分";
        } else {
            strRMB = strRMB + "圆整";
        }
        return strRMB;
